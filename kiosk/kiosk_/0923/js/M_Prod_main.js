    ...
    const sub_listBtn = (product) => {
        ...
        if (product.desc.includes("태닝") || product.desc.includes("사우나") || product.desc.includes("크라이오테라피") || product.desc.includes("운동복") || product.desc.includes("락커룸")) {
            option1Btn.addEventListener('click', (e) => {
                ...
                option1Btn.style.backgroundColor = '#FAB900';
            ...
            option2Btn.addEventListener('click', (e) => {
                ...
                option2Btn.style.backgroundColor = '#FAB900';
            ...
            option1Btn.addEventListener('click', (e) => {
                ...
                option1Btn.style.backgroundColor = productCart.option1Selected ? '#FAB900' : '';
            });
        } else {
            option1Btn.addEventListener('click', (e) => {
                productCart.option1Selected = !productCart.option1Selected;
            ...
            option2Btn.addEventListener('click', (e) => {
                ...
                option2Btn.style.backgroundColor = productCart.option2Selected ? '#FAB900' : '';
            });
        }
...
class ProductCart {
    ...
    resetButtonStyles() {
        const option1Btn = document.querySelector("#sportswear_btn");
        const option2Btn = document.querySelector("#locker_btn");
